...
import { BreadcrumbItem, Breadcrumbs, Tabs, Tab, Chip } from "@nextui-org/react";
    ...
    <div className="px-8 py-24">
      ...
      <section className="mt-4 flex flex-col gap-10 lg:flex-row">
        <div className="w-full lg:w-2/3">
          <h1 className="text-2xl font-semibold text-primary-700 mb-4">
            {dataDetailStation?.name}
          </h1>
          <div className="flex items-center gap-2 text-foreground-500 mb-4">
            <FaLocationDot width={16} />
            <p>{dataDetailStation?.location?.region}</p>
          </div>
          <div className="">
            <Image
